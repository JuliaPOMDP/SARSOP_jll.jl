...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import sarsop_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("55c239ea-a488-56cb-afaa-1eaf9ccf0106"))
platforms = [Pkg.Artifacts.unpack_platform(e, "sarsop", artifacts_toml) for e in artifacts["sarsop"]]
...
if best_platform === nothing
    @debug("Unable to load sarsop; unsupported platform $(triplet(platform_key_abi()))")
else
